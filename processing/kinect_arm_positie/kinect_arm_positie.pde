...
void drawText(int userId,int jointType1,int jointType2,int jointCenter)
{
  ...
  text = context.getJointPositionSkeleton(1,jointType1,jointPos1); // userId vervangen door 1
  text = context.getJointPositionSkeleton(1,jointType2,jointPos2); // userId vervangen door 1
  text = context.getJointPositionSkeleton(1,jointCenter,jointPos0); // userId vervangen door 1
